...
#define HOJA_IMU_CHAN_A_CS_PIN          19 
...
#define HOJA_HAPTICS_CHAN_B_PIN    14
#define HOJA_HAPTICS_CHAN_SWAP     1

#define HOJA_HAPTICS_MAX        0.35f 
...
#define RGB_DRIVER_OUTPUT_PIN   24
