...
#define HOJA_PRODUCT        "Hoverboard"
...
#define HOJA_SINPUT_GAMEPAD_SUBTYPE    0 
#define HOJA_SINPUT_GAMEPAD_TYPE       0 
#define HOJA_SINPUT_GAMEPAD_FACESTYLE  0 
...
#define HOJA_DEVICE_MANIFEST_URL    "https://raw.githubusercontent.com/HandHeldLegend/hoja-device-fw/main/builds/hoverboard/manifest.json"
#define HOJA_DEVICE_FIRMWARE_URL    "https://raw.githubusercontent.com/HandHeldLegend/hoja-device-fw/main/builds/hoverboard/hoverboard.uf2"
...
#define NESBUS_DRIVER_CLOCK_PIN     1
#define NESBUS_DRIVER_LATCH_PIN     2
...
#define RGB_DRIVER_OUTPUT_PIN   26
...
#define HOJA_INPUT_SLOTS { \
    (inputInfoSlot_s) {/*South*/.input_name="A1", .input_type=INPUT_TYPE_HOVER, .rgb_group=2}, \
    (inputInfoSlot_s) {/*East*/.input_name="A2", .input_type=INPUT_TYPE_HOVER, .rgb_group=1}, \
    (inputInfoSlot_s) {/*West*/.input_name="A3", .input_type=INPUT_TYPE_HOVER, .rgb_group=4}, \
    (inputInfoSlot_s) {/*North*/.input_name="A4", .input_type=INPUT_TYPE_HOVER, .rgb_group=3}, \
    (inputInfoSlot_s) {/*Up*/.input_name="A5", .input_type=INPUT_TYPE_HOVER, .rgb_group=5}, \
    (inputInfoSlot_s) {/*Down*/.input_name="A6", .input_type=INPUT_TYPE_HOVER, .rgb_group=6}, \
    (inputInfoSlot_s) {/*Left*/.input_name="A7", .input_type=INPUT_TYPE_HOVER, .rgb_group=7}, \
    (inputInfoSlot_s) {/*Right*/.input_name="A8", .input_type=INPUT_TYPE_HOVER, .rgb_group=8}, \
    (inputInfoSlot_s) {/*LB*/.input_name="B1", .input_type=INPUT_TYPE_HOVER, .rgb_group=11}, \
    (inputInfoSlot_s) {/*RB*/.input_name="B2", .input_type=INPUT_TYPE_HOVER, .rgb_group=12}, \
    (inputInfoSlot_s) {/*LT*/.input_name="B3", .input_type=INPUT_TYPE_HOVER, .rgb_group=13}, \
    (inputInfoSlot_s) {/*LTANALOG*/0}, \
    (inputInfoSlot_s) {/*RT*/.input_name="B4", .input_type=INPUT_TYPE_HOVER, .rgb_group=14}, \
    (inputInfoSlot_s) {/*RTANALOG*/0}, \
    (inputInfoSlot_s) {/*LP1*/.input_name="B5", .input_type=INPUT_TYPE_HOVER,}, \
    (inputInfoSlot_s) {/*RP1*/.input_name="B6", .input_type=INPUT_TYPE_HOVER,}, \
    (inputInfoSlot_s) {/*LP2*/.input_name="B7", .input_type=INPUT_TYPE_HOVER,}, \
    (inputInfoSlot_s) {/*RP2*/.input_name="B8", .input_type=INPUT_TYPE_HOVER,}, \
    ...
    (inputInfoSlot_s) {/*MISC3*/.input_name="Misc", .input_type=INPUT_TYPE_DIGITAL}, \
    (inputInfoSlot_s) {/*MISC4*/0}, \
    (inputInfoSlot_s) {/*TP1*/0}, \
    (inputInfoSlot_s) {/*TP2*/0}, \
    (inputInfoSlot_s) {/*LS*/.input_name="C1", .input_type=INPUT_TYPE_HOVER}, \
    (inputInfoSlot_s) {/*LX_RIGHT*/.input_name="C2", .input_type=INPUT_TYPE_HOVER, .rgb_group=9}, \
    (inputInfoSlot_s) {/*LX_LEFT*/.input_name="C3", .input_type=INPUT_TYPE_HOVER}, \
    (inputInfoSlot_s) {/*LY_UP*/.input_name="C4", .input_type=INPUT_TYPE_HOVER}, \
    (inputInfoSlot_s) {/*LY_DOWN*/.input_name="C5", .input_type=INPUT_TYPE_HOVER}, \
    (inputInfoSlot_s) {/*RS*/.input_name="C6", .input_type=INPUT_TYPE_HOVER}, \
    (inputInfoSlot_s) {/*RX_RIGHT*/.input_name="C7", .input_type=INPUT_TYPE_HOVER, .rgb_group=10}, \
    (inputInfoSlot_s) {/*RX_LEFT*/.input_name="C8", .input_type=INPUT_TYPE_HOVER}, \
    (inputInfoSlot_s) {/*RY_UP*/.input_name="D1", .input_type=INPUT_TYPE_HOVER}, \
    (inputInfoSlot_s) {/*RY_DOWN*/.input_name="D2", .input_type=INPUT_TYPE_HOVER} \
}
