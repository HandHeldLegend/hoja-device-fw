...
static const hoja_config_s _hoja_config = {
    ...
    .imu = {
        ...
        .channel_b = {
            .bus = LSM6DSR_BUS_SPI, .spi_instance = 0, .cs_gpio = 25,
            .gyro  = { .invert_y = true },
            .accel = { .invert_y = true },
        },
    },
    ...
    .device_name   = "ProGCC 3.2",
    .device_maker  = "HHL",
    .manifest_url  = "https://raw.githubusercontent.com/HandHeldLegend/hoja-device-fw/main/builds/progcc_3.2/manifest.json",
    .firmware_url  = "https://raw.githubusercontent.com/HandHeldLegend/hoja-device-fw/main/builds/progcc_3.2/progcc_3.2.uf2",
