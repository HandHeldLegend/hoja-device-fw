...
static const hoja_config_s _hoja_config = {
    ...
    .imu = {
        .channel_count = 2,
        .channel_a = {
            .bus = LSM6DSR_BUS_SPI, .spi_instance = 0, .cs_gpio = 28,
            .gyro  = { .invert_x = true },
            .accel = { .invert_x = true },
        },
        .channel_b = {
            .bus = LSM6DSR_BUS_SPI, .spi_instance = 0, .cs_gpio = 29,
            .gyro  = { .invert_y = true },
            .accel = { .invert_y = true },
        },
    },
    ...
    .rgb = {
        .groups = {
            { .name = "A",        .leds = RGB_GROUP(18) },
            { .name = "B",        .leds = RGB_GROUP(19) },
            { .name = "X",        .leds = RGB_GROUP(17) },
            { .name = "Y",        .leds = RGB_GROUP(16) },
            { .name = "D Up",     .leds = RGB_GROUP(11) },
            { .name = "D Down",   .leds = RGB_GROUP(9) },
            { .name = "D Left",   .leds = RGB_GROUP(8) },
            { .name = "D Right",  .leds = RGB_GROUP(10) },
            { .name = "L Stick",  .leds = RGB_GROUP(4, 5, 6, 7) },
            { .name = "R Stick",  .leds = RGB_GROUP(0, 1, 2, 3) },
            { .name = "L",        .leds = RGB_GROUP(20) },
            { .name = "R",        .leds = RGB_GROUP(22) },
            { .name = "ZL",       .leds = RGB_GROUP(21) },
            { .name = "ZR",       .leds = RGB_GROUP(23) },
            { .name = "Home",     .leds = RGB_GROUP(14) },
            { .name = "Capture",  .leds = RGB_GROUP(13) },
            { .name = "Plus",     .leds = RGB_GROUP(15) },
            { .name = "Minus",    .leds = RGB_GROUP(12) },
        },
