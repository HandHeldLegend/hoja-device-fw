...
#define HOJA_SPI_0_GPIO_CLK   22 
#define HOJA_SPI_0_GPIO_MOSI  23 
#define HOJA_SPI_0_GPIO_MISO  20 
#define SPI_INSTANCE_0        0 

// I2C HAL Setup
#define HOJA_I2C_1_ENABLE       1 
#define HOJA_I2C_1_GPIO_SDA     2 
#define HOJA_I2C_1_GPIO_SCL     3 
...
#define NESBUS_DRIVER_DATA_PIN      4
#define NESBUS_DRIVER_CLOCK_PIN     6
...
#define HOJA_INPUT_SLOTS { \
    (inputInfoSlot_s) {/*South*/.input_name="South", .input_type=INPUT_TYPE_HOVER, .rgb_group=2}, \
    (inputInfoSlot_s) {/*East*/.input_name="East", .input_type=INPUT_TYPE_HOVER, .rgb_group=4}, \
    (inputInfoSlot_s) {/*West*/.input_name="West", .input_type=INPUT_TYPE_HOVER, .rgb_group=3}, \
    (inputInfoSlot_s) {/*North*/.input_name="North", .input_type=INPUT_TYPE_HOVER, .rgb_group=5}, \
    (inputInfoSlot_s) {/*Up*/.input_name="D Up", .input_type=INPUT_TYPE_HOVER}, \
    (inputInfoSlot_s) {/*Down*/.input_name="D Down", .input_type=INPUT_TYPE_HOVER}, \
    (inputInfoSlot_s) {/*Left*/.input_name="D Left", .input_type=INPUT_TYPE_HOVER}, \
    (inputInfoSlot_s) {/*Right*/.input_name="D Right", .input_type=INPUT_TYPE_HOVER}, \
    (inputInfoSlot_s) {/*LB*/.input_name="L", .input_type=INPUT_TYPE_HOVER}, \
    (inputInfoSlot_s) {/*RB*/.input_name="R", .input_type=INPUT_TYPE_HOVER}, \
...
#define RGB_DRIVER_OUTPUT_PIN   28
